...
Bạn nhận thấy quy luật gì qua bốn phản hồi? Khi temperature thấp ví dụ như 0 thì spam câu hỏi qua nhiều lần câu trả lời k khác nhau là mấy. Khi temperature tăng lên câu trả lời trở nên đa dạng, sáng tạo hơn nhưng cũng dễ ảo tưởng. Temperature càng cao thì mức độ ngẫu nhiên trong quá trình sinh text càng lớn.

Bạn sẽ đặt temperature bao nhiêu cho chatbot hỗ trợ khách hàng, và tại sao? chọn thấp 0-0.2 để rag bớt bịa chuyện, ưu tiên trả lời chính xác.

Bài tập 2.2 — Đánh Đổi Chi Phí
Ước tính xem GPT-4o đắt hơn GPT-4o-mini bao nhiêu lần cho workload này: nếu mà mỗi ngày có:
...
Mô tả một trường hợp mà chi phí cao hơn của GPT-4o là xứng đáng, và một trường hợp GPT-4o-mini là lựa chọn tốt hơn: GPT-4o phù hợp cho các tác vụ yêu cầu suy luận mạnh và độ chính xác cao như trợ lý lập trình, phân tích tài liệu hoặc hỗ trợ chuyên môn. GPT-4o-mini phù hợp cho chatbot FAQ, ứng dụng phản hồi nhanh hoặc hệ thống có lượng request lớn cần tối ưu chi phí.
